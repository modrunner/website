export default defineAppConfig({
	...
	meta: {
		authUrl:
			'https://discord.com/api/oauth2/authorize?client_id=968164973467541574&redirect_uri=http%3A%2F%2Flocalhost%3A3000%2Flogin&response_type=code&scope=identify',
	},
});
